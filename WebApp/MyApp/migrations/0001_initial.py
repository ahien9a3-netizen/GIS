        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "NguoiDung",
                    models.CharField(
                        db_column="nguoidung", default="User", max_length=255
                    ),
                ),
                ("Diem", models.IntegerField(db_column="diem", default=5)),
                (
                    "BinhLuan",
                    models.TextField(blank=True, db_column="binhluan", null=True),
                ),
                (
                    "NgayTao",
